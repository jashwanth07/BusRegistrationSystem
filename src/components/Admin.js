...
const Admin = () => {
    return (
        <div className='container'>
            ...
            <div className='col-lg-12 col-md-3 col-sm-2 d-flex justify-content-center'>
                ...
                <div className="card shadow bg-dark text-white op_Cards m-3">
                    <div className='card-body'>
                        <h1 className='card-text'><Link to="/viewAllProducts" className="nav-link">View All Products</Link></h1>
                    </div>
                </div>
            </div>
